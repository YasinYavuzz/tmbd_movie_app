...
class _UpComingState extends State<UpComing> {
  ...
  void initState() {
    ...
    changePageIndexProvider.getUpComingPageDataWithPage();
    super.initState();
  }
  @override
                          ...
                          child: Container(
                            decoration: BoxDecoration(
                                image: DecorationImage(
                                    image: NetworkImage(
                                        'https://image.tmdb.org/t/p/w600_and_h900_bestv2/${value.upComingModel!.results![index].posterPath}'),
                                    fit: BoxFit.fill)
                            ),
                          ),
                        );
                  ...
                  Padding(
                    ...
                    child: 
                        ...
                        children: [
                          GestureDetector(
                              onTap: (){
                                value.getUpComingPageDecrement();
                              },
                              child: Icon(
                          ...
                          GestureDetector(
                            onTap: () {
                              value.getUpComingPageIncrement();
                            },
                            child: Icon(
